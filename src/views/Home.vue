<template>
  <spotlighted-pokemon v-if="SpotlightedPokemon.spotlighted" :pokemon="SpotlightedPokemon"></spotlighted-pokemon>
  <div class="home-container" >
    <search-box class="search-position"></search-box>
    <div class="pokemons-container">
      <pokecard v-for="(pokemon, index) in Pokemons" :key="index" :pokemon="pokemon"></pokecard>
    </div>
    <div class="button-wrapper" @click="loadMorePokemons">
      <button class="load-more-button bold-font"><p class="special-font">Load More</p></button>
    </div>
  </div>
</template>
